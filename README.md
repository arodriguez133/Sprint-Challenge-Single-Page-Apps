...
> Answer: Client Side Routing is a javascript managed routing option. It offers control over your site URL and content without necessarily having to wait for a server to respond with content.
